...
p1 = Post.objects.create(author=author, categoryType='NW', title='sometitle', text='somebigtext')
p2 = Post.objects.create(author=author, categoryType='AR', title='Sport', text='blablabla')
p3 = Post.objects.create(author=author2, categoryType='AR', title='Politics', text='sometext again')
